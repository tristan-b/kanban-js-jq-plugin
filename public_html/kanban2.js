...
//                        }
        ...
        makeColumn: function (title) {
            ...
            heading.on("click", function () {
                var url = "http://katara.techtime.org/gui2/login.jsp?keyID=0&kb=CX1&";
...
//                    dropped.css({"position": "relative", "top": "0px", "left": "0px"});
        ...
        makeCard: function (card) {
            ...
            elem.on("mouseup", function () {
                ...
                var hl = $(this).find(".hotlink").data("link");
                // $("#ewFrame").attr("src", url);
                console.log(hl);
                // document.getElementById("ewFrame").src = url;
//                    var iFrm = document.createElement("iframe");
...
//                $("#ewFrame").attr("src", hl);
            ...
            var hotlink = "http://katara.techtime.org/gui2/login.jsp?keyID=0";
...
//            logit("Id: " + recId + " State: " + state);
            var url = "http://katara.techtime.org/ewws/EWUpdate?$KB=CX1" +
