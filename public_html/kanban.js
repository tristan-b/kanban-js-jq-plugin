...
(function ($, window, document, undefined) {
    ...
    var dragCheck = false,
            self, // have a closure wide this var available
            $columns, // array of jquery column els
            cards; // card objects returned from chart datasource
    ...
    var pluginName = "Kanban",
            defaults = {
                user: "tribsupp",
                password: "Chuffed1",
                columns: ["Counter Offer", "Agreed", "Pending", "Declined", "Completed"],
...
//                    var iFrm = document.createElement("iframe");
           ...
           //     $("#ewFrame").attr("src", url);
                var xpos = (screen.availWidth - 600) / 2,
                        ...
                        wnd_pop = window.open("example.org", '_blank', size);
...
//                    "&assigned_to="+encodeURIComponent(formFields.assigned_to);
    ...
    function toolBar(toolbarSettingsObj){
        var $toolbar = $("<div/>", {"class": "ui-widget-header, ui-corner-all",
        id: "kanbanToolbar"});
    }
    function filterCards(fieldName, value){
